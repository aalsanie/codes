...
These snapshots protect Codes' semantic contract independently from the Java API snapshot in `api/codes.api`.
...
A snapshot change represents a change to the semantic contract and must be reviewed together with the code that requires it.
