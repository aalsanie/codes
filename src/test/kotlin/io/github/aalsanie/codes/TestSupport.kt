...
internal fun assertTrue(value: Boolean, message: String = "expected true") {
    if (!value) throw AssertionError(message)
}

internal fun assertFalse(value: Boolean, message: String = "expected false") {
    if (value) throw AssertionError(message)
}

internal fun assertNull(value: Any?, message: String = "expected null") {
    if (value != null) throw AssertionError("$message, got <$value>")
}

internal fun assertSame(expected: Any?, actual: Any?) {
    if (expected !== actual) throw AssertionError("expected same instance <$expected>, got <$actual>")
}

internal fun assertNotSame(unexpected: Any?, actual: Any?) {
...
internal fun assertNotEquals(unexpected: Any?, actual: Any?) {
